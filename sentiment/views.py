...
api_key = 'AIzaSyC-IIcpUxit_hL9l-HsY9s9kZkLQITq7Dg'
...
def coments(video_id):
    ...
    while True:
        for i in video_response['items']:
            yt_corpus1.append(i['snippet']["topLevelComment"]["snippet"]["textOriginal"])
            yt_corpus1weights.append(i['snippet']["topLevelComment"]["snippet"]["likeCount"])
